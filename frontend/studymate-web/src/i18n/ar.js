...
export default {
  ...
  server: {
    ...
    /* كل رقم يليه "حرفًا" مباشرة، فلا يقع رقمان متجاورين ولا يقف رقم
       في آخر الجملة حيث تسحبه خوارزمية الاتجاه بعيدًا عن موضعه. */
    contactEmpty: 'اكتب رسالتك قبل الإرسال.',
    contactTooShort: 'لا تقل الرسالة عن {min} حرفًا.',
    contactTooLong: 'لا تزيد الرسالة على {max} حرفًا.',
    contactRateLimited: 'أرسلت عدة رسائل في الساعة الماضية. انتظر قليلًا قبل إرسال رسالة أخرى.',

    /* رسائل تأكيد البريد الثلاث.

       verificationCodeInvalid هي كل ما يقوله الخادم عند الفشل - رمز خاطئ أو
       منتهٍ أو مستعمل أو محاولات كثيرة أو حساب غير موجود، كلها تُجاب بها.
       فلا تكون العربية أدقّ من الإنجليزية هنا: الغموض مقصود. */
    emailNotVerified:
      'لم يُؤكَّد هذا البريد الإلكتروني بعد. أدخل الرمز الذي أرسلناه إليك، أو اطلب رمزًا جديدًا.',
    verificationCodeInvalid: 'هذا الرمز غير صالح. اطلب رمزًا جديدًا وحاول مرة أخرى.',
    verificationRateLimited: 'طُلبت رموز كثيرة لهذا الحساب. انتظر قليلًا قبل طلب رمز آخر.',
  },
  ...
  nav: {
    ...
    /* اسم وجهة، لا أمر - فهو رابط في الشريط الجانبي. */
    contact: 'اتصل بنا',
  ...
  auth: {
    ...
    /* خطوة التأكيد.
       ...
       لا رقم هنا: مدة صلاحية الرمز مذكورة في رسالة البريد نفسها، وتكرارها
       في الواجهة يعني موضعًا ثانيًا يتقادم حين تتغير المدة. و"ستة أرقام"
       مكتوبة بالحروف لا بالرقم، فالجملة عربية خالصة ولا يُعاد ترتيبها. */
    verifyTitle: 'تأكيد بريدك الإلكتروني',
    verifySubtitle: 'أدخل الرمز الذي أرسلناه إليك للتو لإتمام إنشاء حسابك.',
    verifyFromSignInSubtitle: 'لم يُؤكَّد هذا الحساب بعد. أدخل الرمز لتسجيل الدخول.',

    /* العنوان نفسه ليس داخل هذه الجملة، بل عنصر مستقل بجانبها - انظر
       التعليق في VerifyEmailPanel.jsx: عنوان بريد لاتيني داخل سطر عربي
       يُعاد ترتيبه فيقع النطاق قبل الاسم. */
    verifySentTo: 'أرسلنا رمزًا من ستة أرقام إلى:',

    verificationCode: 'رمز التأكيد',
    verificationCodeHint: 'ستة أرقام، من الرسالة التي أُرسلت إليك للتو.',
    verify: 'أكّد',

    noCodeYet: 'لم يصلك الرمز؟',
    sendNewCode: 'أرسل رمزًا جديدًا',

    /* بنفس تحفّظ الخادم: رمز في الطريق إن كان العنوان بحاجة إلى تأكيد، لا
       إقرار بأن الحساب موجود. */
    verifyResent: 'إن كان هذا العنوان بحاجة إلى تأكيد، فرمز جديد في طريقه إليه.',

    backToSignIn: 'العودة إلى تسجيل الدخول',
    couldNotVerify: 'تعذّر تأكيد الرمز.',
    couldNotResend: 'تعذّر إرسال رمز جديد.',
  ...
  contact: {
    /* عنوان الصفحة. أما nav.contact فهو الرابط المؤدّي إليها. */
    title: 'اتصل بنا',

    subtitle: 'أخبرنا بمشكلة واجهتك، أو بشيء ترى أنه يجب أن يعمل بشكل آخر.',

    fullName: 'اسمك',
    email: 'بريدك الإلكتروني',

    fromAccountHint: 'مأخوذان من حسابك، لنعرف من كتب الرسالة وإلى أين نردّ.',

    message: 'الرسالة',
    messagePlaceholder: 'ما الذي حدث، وما الذي كنت تتوقعه بدلًا منه.',

    /* زر، فالصيغة أمر. */
    send: 'أرسل الرسالة',

    /* "وصلت" لا "سنردّ": ما تأكّد فعلًا هو أن الرسالة حُفظت. */
    sent: 'وصلتنا رسالتك. شكرًا لك.',

    couldNotSend: 'تعذّر إرسال رسالتك.',
  },
